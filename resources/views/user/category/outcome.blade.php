...
@section('title', 'Outcome Category')
@section('breadcrumb')
    <ol class="breadcrumb">
        <li class="text-sm breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
        <li class="text-sm breadcrumb-item active" aria-current="page">Outcome</li>
    </ol>
@endsection
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <form action="{{ route('outcome.category.store') }}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-12">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-12">
                                <h4 class="card-title">Data Category Outcome</h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="modal fade" id="editModal{{ $result->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $result->id }}" aria-hidden="true">
                                        <div class=" modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('outcome.category.update', $result->id) }}" method="post">
                                                    @csrf
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{ route('outcome.category.destroy', $result->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
